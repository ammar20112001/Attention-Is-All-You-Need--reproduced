...
class DataModuleLightning(LightningDataModule):
    ...
    def __init__(self, config_arg=config, data_dir='./Data'):
        ...
        self.train_frac = self.config['dataset_configs']['train_frac']
        self.test_val_frac = self.config['dataset_configs']['test_val_frac']
    ...
    def train_dataloader(self):
        return DataLoader(self.train_set, batch_size=self.config['dataset_configs']['batch_size'])

    def val_dataloader(self):
        return DataLoader(self.val_set, batch_size=self.config['dataset_configs']['batch_size'])
        
    def test_dataloader(self):
        return DataLoader(self.test_set, batch_size=self.config['dataset_configs']['batch_size'])
